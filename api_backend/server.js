...
const corsOptions = {
  origin: [
    'http://localhost:8080',
    'https://urduai.org', // Your main domain
    'https://www.urduai.org', // With www subdomain
    'https://chat.urduai.org', // Your chat subdomain
    /\.urduai\.org$/ // Allow all subdomains
  ],
  methods: ['GET', 'POST'],
...
// Change port to use environment variable or default to 8080
